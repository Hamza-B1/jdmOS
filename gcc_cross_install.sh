...
# GCC cross compiler for ~~i386~~ x86_64 systems
...
export PREFIX="/usr/local/ix86_64elfgcc"
...
# https://github.com/mell-o-tron/MellOs original copy from here, all I did was change it to target x86_64